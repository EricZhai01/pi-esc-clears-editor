...
```bash
pi install git:github.com/EricZhai01/pi-esc-clears-editor@v0.1.0
```

Or copy `extensions/esc-clears-editor.ts` to `~/.pi/agent/extensions/` (global) or
`.pi/extensions/` (project). Run `/reload` to apply without restarting.
