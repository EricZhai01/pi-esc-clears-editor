...
173ms. Set `PI_DOUBLE_ESC_MS` (100–1000) to tune it.
...
only trades lag against how slow a deliberate double tap may be. At 173ms both
presses must land inside 173ms.
